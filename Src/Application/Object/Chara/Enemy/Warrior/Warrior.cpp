...
void Warrior::PostUpdate()
{
	...
	//========================================
	{
		...
		// 球の中心点を設定
		Math::Vector3 pos = { 5.0f,3.0f,5.0f };
		sphere.m_sphere.Center = m_pos + pos;
		...
		if (isHit)
		{
			m_pDebugWire->AddDebugSphere(m_pos + Math::Vector3(5.0f, 3.0f, 5.0f), 2.0f, kGreenColor);
		}
	}
...
void Warrior::Init()
{
	...
	m_pCollider->RegisterCollisionShape("Enemy01Collision", { 0.0f,3.0f,0.0f }, 2.0f, KdCollider::TypeBump);
}
