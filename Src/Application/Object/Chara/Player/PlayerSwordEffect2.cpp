...
void PlayerSwordEffect2::Update()
{
...
void PlayerSwordEffect2::PostUpdate()
{
	// =====================
	// 攻撃判定
	// =====================
...
void PlayerSwordEffect2::DrawUnLit()
{
	KdShaderManager::Instance().m_StandardShader.DrawPolygon(m_polygon, m_world,m_color);
}

void PlayerSwordEffect2::DrawBright()
{
	KdShaderManager::Instance().m_StandardShader.DrawPolygon(m_polygon, m_world,m_color);
}

void PlayerSwordEffect2::SetPos(Math::Vector3 _pos, bool _right,int _atk)
{
	m_pos = _pos;
	m_pos.z -= 0.5f;
...
void PlayerSwordEffect2::Init()
{
	m_polygon = AssetManager::Instance().GetMaterial("playerSwordEffect2");
